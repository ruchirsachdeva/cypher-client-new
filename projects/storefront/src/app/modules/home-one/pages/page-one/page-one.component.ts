...
export class PageOneComponent implements OnInit {
	...
	columnStealDeals$: Observable<Product[]>;
	columnCatProducts$: Observable<Product[]>;
    ...
    ngOnInit(): void {
		...
		this.columnStealDeals$ = this.shopApi.getStealDealsProducts(null, 12);
		this.columnCatProducts$ = this.shopApi.getCatProducts(null, 8);
    }
