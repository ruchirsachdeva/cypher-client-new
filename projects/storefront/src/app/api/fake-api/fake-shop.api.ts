...
export class FakeShopApi extends ShopApi {
	...
	getStealDealsProducts(categorySlug: string, limit: number): Observable<Product[]> {
        return getStealDealsProducts(categorySlug, limit);
    }
	
	getCatProducts(categorySlug: string, limit: number): Observable<Product[]> {
        return getCatProducts(categorySlug, limit);
    }
